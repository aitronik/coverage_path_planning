...
pair<Polygon_list, vector<K::Point_2>> MyDecomposition::run(){
    ...
    pair<Polygon_list, vector<K::Point_2>> output = getDecomposition();

    m_decomposition.clear();
    m_initialPolygon.reset();
    m_indexedPolygons.clear();
