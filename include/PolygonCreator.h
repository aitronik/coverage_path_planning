...
class PolygonCreator {
    ...
    private:
        ...
        */
         ...
         */
        CGAL::Polygon_with_holes_2<K2> mergePolygons(const vector<pair<CGAL::Polygon_with_holes_2<K>, int>>& polygonUnion);
       ...
       /**
        * @brief Function that estimates the adjacency matrix of the input subpolygons
        * 
        * @param polygons input vector of subpolygons
        */
        void checkAdjacency(vector<pair<CGAL::Polygon_with_holes_2<K>, int>>& polygons);
        ...
        */
        ...
        vector<pair<K::Point_2, int>> defineOptimalPath(int numOfSubPolygons, Polygon_list subPolygons);
